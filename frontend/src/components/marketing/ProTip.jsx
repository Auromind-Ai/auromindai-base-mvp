  ...
  return (
    <div className="rounded-xl bg-[#0a0d17] border border-[#1a2136] p-4 sm:p-5 text-xs sm:text-sm transition-all duration-200 shadow-sm">
      <div className="flex items-center gap-2.5 mb-2">
        <div className="w-6 h-6 rounded-lg bg-gradient-to-b from-[#814AC8]/40 to-[#221253]/40 flex items-center justify-center shrink-0">
          <Lightbulb size={14} className="text-white" />
        </div>
        <span className="font-medium text-white text-sm sm:text-base">Pro Tip</span>
      </div>
      <p className="text-white/60 leading-relaxed text-xs sm:text-[13px] pl-1 font-normal">
        {message || defaultMsg}
      </p>
    </div>
  );
