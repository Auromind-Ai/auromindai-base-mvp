            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-[#1A0B10] border border-white/10 space-y-3.5 shadow-lg">
              ...
              <div className="pt-1 flex items-center gap-2.5 flex-wrap">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#1e173b] hover:bg-[#2a2052] border border-[#524185] text-[#C49FE0] hover:text-white text-xs sm:text-sm font-medium transition-all cursor-pointer shadow-sm active:scale-[0.98]"
                >
