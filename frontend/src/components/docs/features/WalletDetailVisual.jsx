...
const WALLETS = [
  {
    ...
    aspectRatio: 'aspect-[1655/950] [&_img]:object-contain',
    frameClassName: 'border border-violet-500/80 shadow-[0_0_18px_rgba(139,92,246,0.14)] hover:border-violet-400',
  ...
  },
  {
    ...
    icon: MessageCircle,
    src: '/images/doc-images/whatsapp-credits-wallet-overview-green.png',
    aspectRatio: 'aspect-[1652/952] [&_img]:object-contain',
    frameClassName: 'border border-emerald-500/80 shadow-[0_0_18px_rgba(16,185,129,0.14)] hover:border-emerald-400',
    ...
    <div className="space-y-3">
      ...
      <div id="wallet-overview-preview" aria-live="polite">
        <DocumentationScreenshot
          ...
          src={wallet.src}
          alt={wallet.alt}
          aspectRatio={wallet.aspectRatio}
          frameClassName={wallet.frameClassName}
