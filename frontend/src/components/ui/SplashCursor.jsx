...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function updatePointerMoveData(pointer, posX, posY, color) {
      ...
      pointer.texcoordX = posX / canvas.width;
      pointer.texcoordY = 1.0 - posY / canvas.height;
      pointer.deltaX = correctDeltaX(pointer.texcoordX - pointer.prevTexcoordX) * 1.1;
      pointer.deltaY = correctDeltaY(pointer.texcoordY - pointer.prevTexcoordY) * 1.1;
