    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 sm:p-6">
        ...
        <motion.div
          ...
          className="relative w-full max-w-[460px] rounded-[24px] border border-white/10 bg-[#0d0d12] p-6 sm:p-7 shadow-[0_35px_100px_rgba(0,0,0,0.95)] text-white z-10 flex flex-col items-center overflow-hidden"
          style={{
