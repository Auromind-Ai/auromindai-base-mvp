...
// Cloudflare official testing sitekey (always passes in non-production environments)
const DUMMY_DEV_SITE_KEY = '1x00000000000000000000AA';
...
export function useTurnstile() {
  ...
  const initWidget = useCallback(async () => {
    ...
    try {
      ...
      if (!envSiteKey && process.env.NODE_ENV !== 'production') {
        console.warn('[Turnstile] NEXT_PUBLIC_TURNSTILE_SITE_KEY env variable missing. Using Cloudflare dev test sitekey (1x00000000000000000000AA).');
      }
