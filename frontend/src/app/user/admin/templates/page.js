...
export default function TemplatesPage() {
  ...
  return (
    <div className={`min-h-full flex-1 flex flex-col bg-[#0b0b14] text-[#f0f0ff] w-full max-w-full overflow-x-hidden ${poppins.className}`} style={{ fontFamily: "'Poppins', sans-serif" }}>
      <div className="max-w-[1600px] mx-auto px-3 sm:px-4 pt-6 sm:pt-8 pb-8 sm:pb-10 w-full max-w-full overflow-x-hidden flex-1 flex flex-col">

        {/* Page header */}
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between mb-6 sm:mb-8 gap-4 w-full shrink-0">
          <div className="flex-1 text-center sm:text-left w-full">
            <h1 className="m-0 mb-1.5 text-2xl sm:text-3xl font-semibold text-[#f0f0ff] tracking-tight">
              Message Templates
            </h1>
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 mb-6 w-full max-w-full shrink-0">
        ...
        {/* Main Content Layout */}
        <div className="flex-1 flex flex-col md:flex-row gap-3 sm:gap-4 items-stretch w-full max-w-full md:min-h-[500px] lg:min-h-[560px]">
          ...
          {/* Right Cards Area */}
          <div className="flex-1 min-w-0 w-full bg-[#070012] border border-[#1e1e3f] rounded-2xl p-3.5 sm:p-5 flex flex-col justify-start min-h-[380px] md:min-h-[500px] lg:min-h-[560px]">
            {loading ? (
