...
export default function CaseStudiesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white relative overflow-x-hidden">
      <title>Auromind Customer Success - AI Case Studies & Metrics</title>
      <meta name="description" content="Read real business success stories. See how startups and enterprises leverage Auromind's conversational AI agents to scale conversion rates." />
