  ...
  const features = [
    {
      ...
      title: "Interactive Demo Bookings",
      description: "AI qualifying agents interact with developers and enterprise managers, mapping calendar openings and booking product demos."
    },
    {
      icon: <Database className="w-5 h-5 text-purple-400" />,
      title: "API Usage Integrations",
      description: "Answer complex technical integration and API questions directly from your developer docs using RAG database syncing."
    },
    {
      icon: <LineChart className="w-5 h-5 text-blue-400" />,
      title: "Growth Performance Metrics",
      description: "Track trial-to-paid conversion indices, monthly recurring revenue growth (MRR), and API activation statistics."
    },
    {
      icon: <Sliders className="w-5 h-5 text-violet-400" />,
      title: "Subscription Conversions",
      description: "AI leads prospective subscribers down optimized funnels, qualifying business requirements, and driving trial signs."
    }
  ];
    ...
    <main className="min-h-screen bg-[#050505] text-white relative overflow-x-hidden">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            >
              <div className="flex items-center gap-2.5 text-sm text-white/80">
                ...
                <span>Pre-qualify developer accounts & API signups</span>
              </div>
              <div className="flex items-center gap-2.5 text-sm text-white/80">
                <CheckCircle2 className="w-4.5 h-4.5 text-indigo-400 flex-shrink-0" />
                <span>Automatic API/Documentation lookup via RAG</span>
              </div>
              <div className="flex items-center gap-2.5 text-sm text-white/80">
                <CheckCircle2 className="w-4.5 h-4.5 text-indigo-400 flex-shrink-0" />
                <span>Schedule high-value enterprise demos automatically</span>
              </div>
              <div className="flex items-center gap-2.5 text-sm text-white/80">
                <CheckCircle2 className="w-4.5 h-4.5 text-indigo-400 flex-shrink-0" />
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-purple-500/20 rounded-3xl blur-2xl group-hover:scale-105 transition-transform duration-500 opacity-60" />
            <div className="relative rounded-2xl border border-white/10 bg-[#0B0B0F]/85 p-2 overflow-hidden shadow-2xl backdrop-blur-xl">
              <Image 
                src="/images/saas.png" 
                alt="AI SaaS Growth Helper Dashboard Visualisation" 
                width={800} 
                height={800}
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Integrate SaaS Growth AI Today</h2>
          <p className="text-white/60 max-w-2xl mx-auto mb-8 text-base">
            Equip your product team with active API docs lookup, pre-qualify user accounts, and book more platform demo sessions automatically.
          </p>
          <Link
            href="/signup"
