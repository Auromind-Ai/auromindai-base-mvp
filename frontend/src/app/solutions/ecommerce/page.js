...
export default function EcommercePage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white relative overflow-x-hidden">
      <title>AI Ecommerce Solutions - Recover Abandoned Carts | Auromind</title>
      <meta name="description" content="Boost your e-commerce conversions. Connect Auromind to sync product catalogs, automate abandoned cart notifications, deliver coupons, and generate checkout links." />
