...
export default function LeadQualificationPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white relative overflow-x-hidden">
      <title>AI Lead Qualification - Filter & Score Leads Automatically | Auromind</title>
      <meta name="description" content="Automate your inbound sales funnel. Use Auromind's AI Lead Qualification Engine to score leads, capture data, and book high-intent meetings." />
