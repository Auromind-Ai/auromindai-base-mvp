...
export default function SalesAutomationPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white relative overflow-x-hidden">
      <title>Sales Automation - Automate Objections & Close Deals | Auromind</title>
      <meta name="description" content="Put your sales funnel on autopilot. Connect Auromind to handle inbound inquiries, resolve objections, deliver checkout links, and sync deals." />
