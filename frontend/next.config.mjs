        ...
        return [
            {
                ...
                headers: [
                    ...
                    { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://*.razorpay.com https://challenges.cloudflare.com https://connect.facebook.net https://*.facebook.com https://*.facebook.net https://va.vercel-scripts.com; frame-src 'self' https://api.razorpay.com https://checkout.razorpay.com https://*.razorpay.com https://challenges.cloudflare.com https://calendar.google.com https://*.facebook.com https://*.facebook.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https: https://*.razorpay.com; media-src 'self' blob: data: https:; font-src 'self' data: https: https://fonts.gstatic.com; connect-src 'self' http://localhost:8000 ws://localhost:8000 http://127.0.0.1:8000 ws://127.0.0.1:8000 https: wss: ws: http: https://api.razorpay.com https://lumberjack-cx.razorpay.com https://*.razorpay.com https://challenges.cloudflare.com;" },
                ],
            },
            {
